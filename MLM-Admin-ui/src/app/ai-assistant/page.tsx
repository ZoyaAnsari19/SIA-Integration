    ...
    <div className="p-6">
      <div className="mb-4 flex items-start justify-between gap-4">
        <div>
          ...
          <div className="mt-1 text-sm text-black/60">
            Ask anything about users, packages, wallet, withdrawals, commissions, or legacy/migration data.
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-[1fr_320px]">
        <ChatFab
          ...
          className="shadow-[0_12px_40px_rgba(0,0,0,0.12)]"
        />

        <div className="h-[75vh] min-h-[560px] overflow-hidden rounded-2xl border border-black/10 bg-white shadow-[0_12px_40px_rgba(0,0,0,0.08)]">
          ...
          <div className="max-h-full overflow-auto p-2">
            {convs.length === 0 ? (
              <div className="p-3 text-sm text-black/50">No chats yet.</div>
            ) : (
                  ...
                  return (
                    <div
                      ...
                      className={[
                        ...
                        isActive ? "bg-emerald-50 ring-1 ring-emerald-200" : "hover:bg-black/5",
                      ].join(" ")}
                    >
                        ...
                        {renamingId === c.conversation_id ? (
                          ...
                          >
                            <input
                              ...
                              className="h-9 w-full rounded-lg border border-black/10 bg-white px-2 text-sm text-black outline-none focus:ring-2 focus:ring-emerald-500"
                              placeholder="Rename chat…"
                            />
                            <div className="mt-1 text-[11px] text-black/50">Enter = save · Esc = cancel</div>
                          </form>
                        ) : (
                          <button
                            type="button"
                          ...
                          >
                            <div className="text-sm font-medium text-black">{c.title || "Chat"}</div>
                            <div className="mt-0.5 flex items-center justify-between text-xs text-black/50">
