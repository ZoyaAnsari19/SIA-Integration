#!/bin/bash
# Production DB par users table mein display_title + display_title_icon_url columns add karta hai.
# Pehle prod DB backup leta hai, phir migration chalta hai.
# Run from repo root: ./MLM-API/scripts/run-display-title-migration-production.sh
...
SQL_FILE="$(cd "$(dirname "${BASH_SOURCE[0]}")/../prisma/migrations" && pwd)/add_display_title_and_icon.sql"

echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "  Production: users.display_title + display_title_icon_url"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
...
echo "Step 2: Applying migration (ALTER TABLE users ADD COLUMN display_title, display_title_icon_url)..."
...
echo ""
echo "✅ Done. users table now has display_title and display_title_icon_url (or already had them)."
echo "   Safe to deploy new API/Admin UI/User UI with display title + icon feature."
echo ""
