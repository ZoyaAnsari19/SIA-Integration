/**
 * Re-credit SPOT commissions for SIA00312 between 20 Feb 2026 and 25 Feb 2026.
 *
 * - Uses CommissionService.handlePurchase for purchases where SIA00312 is in the upline tree.
 * - Intended to be run on the main local DB (mlm-prod-dump, port 5435) after
 *   resetting balances to the 20 Feb 2026 snapshot.
 *
 * Run:
 *   npx tsx scripts/recredit-sia00312-spot-20to25.ts
 */
...
async function main() {
  ...
  console.log('\nPurchases between 20–25 Feb 2026 with SIA00312 in upline:', purchases.length);
