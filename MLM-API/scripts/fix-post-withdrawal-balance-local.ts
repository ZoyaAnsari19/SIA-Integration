...
async function main() {
  console.log('============================================================');
  console.log('Fixing Post-Withdrawal Balance Mismatches (LOCAL DB ONLY)');
  console.log('============================================================\n');
  ...
  for (const withdrawal of usersWithWithdrawals) {
    ...
    // Note: We're not subtracting withdrawal here because withdrawal should already be deducted
    // We're just matching the commissions that should be in other_balance
  ...
  console.log('\n⚠️  WARNING: This will update balances in LOCAL DB!');
